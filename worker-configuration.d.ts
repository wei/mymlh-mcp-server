/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f148bfb729fc0468ff29366e3cf17f0b)
// Runtime types generated with workerd@1.20260430.1 2026-07-28 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		OAUTH_KV: KVNamespace;
		ENV_NAME?: "production" | "alt" | "fallback" | "local";
		MYMLH_CLIENT_ID: string;
		MYMLH_CLIENT_SECRET: string;
		COOKIE_ENCRYPTION_KEY: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV_NAME" | "MYMLH_CLIENT_ID" | "MYMLH_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY">> {}
}
